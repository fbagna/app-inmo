...
export default class PropertyDashboard extends NavigationMixin(LightningElement) {
    ...
    // Dynamic strings buffer captured from event emission flows
    workspaceCountry = '';
    workspaceState = '';
    workspaceCity = '';
    workspaceNeighborhood = '';
    ...
    wiredWorkspaceRecord(result) {
        ...
        if (result.data) {
            ...
            this.rawLocationRecord = {
                country: fields.gbcinmo__Country__c?.value || 'España', // Secures unified baseline fallback defaults
